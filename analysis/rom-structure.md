...
This analysis applies only to the selected `IPKK` input with SHA-256
`659f20ca1d4f43b8b675d3c47217bb875a4f14c62438b08fa42f60467e2bed43`. ROM bytes and extracted payloads are not
included.
...
| ARM9 ROM offset / RAM / entry / size | `0x4000` / `0x02000000` / `0x02000800` / `765204` |
