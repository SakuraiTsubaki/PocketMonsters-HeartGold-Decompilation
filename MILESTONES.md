# Milestones: Pocket Monsters HeartGold

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-HeartGold-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters HeartGold |
| Platform family | Nintendo DS |
| Generation | Generation IV |
| Identity status | `identified` |

The current identity status is `identified`. Existing claims remain provisional for milestone purposes until their manifests and reproduction commands satisfy the exit criteria.
...
- NDS header report; ARM9/ARM7 and overlay inventory; banner, FNT/FAT, filesystem, NARC, compression, and secure-area metadata tables.
...
- Verified ARM/Thumb boundaries for ARM9, ARM7, and overlays; load-address maps; functions, call edges, symbols, data references, and confidence records.
...
- NARC/member schemas plus text, scripts, maps, graphics, sprites, tiles, palettes, fonts, audio, and tables with converters, manifests, and PNG previews.
...
Coordinate reusable Nintendo DS/NARC methods with SoulSilver while keeping Korean-target evidence and title-specific layouts separate.
