# Research Policy — Pocket Monsters HeartGold
...
The primary baseline is the **earliest officially released Japanese version** of Pocket Monsters HeartGold. Every officially released regional, language, and revision variant is investigated as a descendant or sibling of that Japanese-origin baseline.
