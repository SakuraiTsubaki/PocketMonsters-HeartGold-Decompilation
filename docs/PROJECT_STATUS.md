...
The verified Korean HeartGold target is registered and the project has moved beyond metadata-only setup. ARM9/ARM7 layout, NitroFS, overlay inventory, executable hashes, and the first ARM9 startup symbol boundaries are now recorded.
...
- [x] Inventory the verified HeartGold target
