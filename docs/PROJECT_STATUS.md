...
- [ ] Inventory the first verified HeartGold target
...
Run `tools/inventory_target.py` on the first local HeartGold target, register exact identity, then begin ARM9/ARM7/overlay/NitroFS mapping. Retail bytes remain local and read-only.
